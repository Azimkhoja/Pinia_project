...
import { productStore } from "@/stores/getProducts";
...
<template>
    <!-- ======================================= -->
    <section class="bg-gray-100 dark:bg-gray-900 p-3 sm:p-5 mb-5 ">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div
                        ...
                        <router-link to="/product/add" type="button"
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="item in products.products" class="border-b dark:border-gray-700">
                                <th scope="row"
                                ...
                                <td class="px-4 py-3">{{ item.quentity }}</td>
